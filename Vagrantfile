...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "web" do |web|
    ...
    web.vm.provision "puppet" do |puppetlocal|
      puppetlocal.manifests_path = "puppet"
      puppetlocal.manifest_file = "default.pp"
      puppetlocal.module_path = "puppet/modules"
      puppetlocal.options = "--verbose --debug"
            ...
            #puppet.options = "--modulepath='puppet/modules' --verbose --debug -e 'puppet/default.pp'"
        end
  end
